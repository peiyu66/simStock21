...
「小確幸股票模擬機」查詢下載台灣上市股票的歷史股價、計算技術數值、模擬買賣、評估報酬率。
...
## 選股原則
1. 熱門股優於傳統股。
1. 近3年的模擬，平均[實年報酬率](doc/年報酬率.md)在20%以上，平均週期在65天以內者（標示為[紅星股](doc/選股評等.md)）。
...
`小確幸不保證提供的資訊正確即時，亦不對你的投資決策負責。`

### 不是很準確？
小確幸的任務不是實現神諭般的預測，而只是賺小錢。雖然不總是買在最低、賣在最高，卻大約可以持續賺錢、持續形成小確幸，則任務達成。
