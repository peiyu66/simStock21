...
//        let context = coreData.shared.context
        ...
        let contentView = simStockListView(list: self.list)//.environment(\.managedObjectContext, context)
...
//        (UIApplication.shared.delegate as? AppDelegate)?.saveContext()
        ...
        backgroundRequest().submitBGTask("com.mystock.simStock21.BGTask")
    }
